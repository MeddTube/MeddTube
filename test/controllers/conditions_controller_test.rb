...
class ConditionsControllerTest < ActionController::TestCase
  ...
  test "should create condition" do
    assert_difference('Condition.count') do
      post :create, condition: { dateonset: @condition.dateonset, description: @condition.description, icd9: @condition.icd9, name: @condition.name }
    end
  ...
  test "should update condition" do
    patch :update, id: @condition, condition: { dateonset: @condition.dateonset, description: @condition.description, icd9: @condition.icd9, name: @condition.name }
    assert_redirected_to condition_path(assigns(:condition))
  end
