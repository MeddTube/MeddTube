...
class LabsControllerTest < ActionController::TestCase
  ...
  test "should create lab" do
    assert_difference('Lab.count') do
      post :create, lab: { datedrawn: @lab.datedrawn, name: @lab.name, units: @lab.units, value: @lab.value }
    end
  ...
  test "should update lab" do
    patch :update, id: @lab, lab: { datedrawn: @lab.datedrawn, name: @lab.name, units: @lab.units, value: @lab.value }
    assert_redirected_to lab_path(assigns(:lab))
  end
