...
class DietsControllerTest < ActionController::TestCase
  ...
  test "should create diet" do
    assert_difference('Diet.count') do
      post :create, diet: { guidelines: @diet.guidelines, name: @diet.name, recomendations: @diet.recomendations, restrictions: @diet.restrictions }
    end
  ...
  test "should update diet" do
    patch :update, id: @diet, diet: { guidelines: @diet.guidelines, name: @diet.name, recomendations: @diet.recomendations, restrictions: @diet.restrictions }
    assert_redirected_to diet_path(assigns(:diet))
  end
